...
const processButtonPress = (input: string) => {
...
const numberPress = (numberPressed: string) => {
...
const unaryOperatorPress = (unaryPressed: string) =>  {
...
const binaryOperatorPress = (binaryPressed: string) => {
...
const performBinaryOperation = (val1: number, operator: string, val2: number) => {
    let output = null;
    switch (operator) {
...
const setDisplay = (numberAsString: string) => {
